    ...
    @IBAction func signInButton(_ sender: Any) {
        ...
        Auth.auth().createUser(withEmail: emailTextField.text!, password: passwordTextField.text!) { (user, error) in
            ...
            if user != nil {
                ...
                //寫入使用者資料
                let dic = ["email":"\(self.emailTextField.text!)","password":"\(self.passwordTextField.text!)","userName":"\(self.userNameTextField.text!)","userBirthday":"\(self.userDate)"] as [String:Any]
